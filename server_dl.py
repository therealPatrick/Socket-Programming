...
def send():
	global transmit_window, time_out, buffer, clock, pack_counter, packets, first, recieve_buffer
...
def recieve():
	...
	if (len(recieve_buffer) == transmit_window + 1):
		for i in recieve_buffer:
			s.send(i)
